...
// Payout List
$payout_list = $payouts->getAll($seller->id, 'seller_id', '=');
// Product List
                            ...
                            <div class="mb-3">
                                <a href="dashboard/order-details/view/<?= $v->invoice; ?>" class="text-reset">
                                    <div class="d-flex justify-content-between">
                                        <img src="media/images/product/<?= $first_product->cover; ?>" class="br-2p" style="height:40px; width: 40px; object-fit: cover;">
                                        <div class="ml-3 flex-grow-1 d-flex align-self-center justify-content-between">
                                            <div class="">
