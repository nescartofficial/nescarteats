...
<?php if ($order) {
    ...
    $first_product = $Menus->get($order_details[0]->id);
    ...
    $order_status = $order->status == 'awaiting' ? array('title' => 'Awaiting Delivery', 'color' => 'text-accent') : $order_status;
    $order_status = $order->status == 'completed' ? array('title' => 'Delivered', 'color' => 'text-green') : $order_status;

    $status = $order_details ? current($order_details)->status : null;
?>
    <div class="container-fluid container-md container--max--xl">
        <div class="py-5">
        ...
        <div class="d-lg-none sa-page-meta mb-5">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap">
                                                ...
                                                <div class="col-8 ms-3">
                                                    ...
                                                    <div class="mt-3 mt-lg-1 d-flex justify-content-between">
                                                        ...
                                                        <span class="d-lg-none fs-12p font-weight-bold"><?= Helpers::format_currency(($menu->price * $detail->quantity)); ?></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
