        ...
        <div class="row gy-4">
            ...
            <div class="col-12">
                <a href="dashboard/profile">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg id="Profile" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 52.69 52.69">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Manage your profile</span>
                        </div>

                        <svg id="chevron-right" xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 31.393 52.867">
            ...
            <div class="col-12">
                <a href="dashboard/address">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg id="Address" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 45.503 54.917">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Manage your addresses</span>
                        </div>
            ...
            <div class="col-12">
                <a href="dashboard/wallet">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg id="Wallet" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 52.116 39.087">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Manage your payment methods</span>
                        </div>
            ...
            <div class="col-12">
                <a href="dashboard/subscriptions">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg id="Supscription" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40.844 44.199">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Manage your meal subscription</span>
                        </div>
            ...
            <div class="col-12">
                <a href="dashboard/referral">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg id="Refferals" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 45.459 41.326">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Refer your friends and earn</span>
                        </div>
            ...
            <div class="col-12">
                <a href="dashboard/preferences">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg id="Preferences" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 42.667 40.297">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Customise Nescart to suit you.</span>
                        </div>
                ...
                <a href="dashboard/change-password">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Manage your security.</span>
                        </div>
            ...
            <div class="col-12">
                <a href="controllers/logout.php">
                    <div class="rounded px-4 py-3 bg-white d-flex align-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 51.37 51.37">
                        ...
                        <div class="flex-fill ms-3">
                            ...
                            <span class="fs-12p">Ooops! you are leaving.</span>
                        </div>
