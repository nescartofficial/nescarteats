        ...
        <div class="row gy-4 mb-4">
            <div class="col-lg-6">
                <div class="d-flex">
                    ...
                    <button class="btn bg-primary text-white" data-bs-toggle="modal" data-bs-target="#newSpecialMenuModa" disabled>Add New Special</button>
                </div>
            </div>
            ...
            <div class="col-lg-6">
                <form action="">
                    <div class="input-group input-group-lg">
                        ...
                        <button type="submit" class="btn bg-primary border-0 input-group-text" style="font-size: 12px;" type="button">Search</button>
                    ...
                    <div class="card card-hover card-horizontal border-0 shadow-sm mb-4">
                        <div class="card-body">
                            <div class="d-flex align-items-center gap-3">
                                <img src="<?= SITE_URL ?>assets/images/menus/<?= $v->cover ?>" alt="" class="img-fluid" style="height:50px; width: 50px; object-fit: cover;">
                                <p class="fs-base mb-0"><?= $v->title; ?></p>
                            </div>
                            <div class="d-flex align-items-center justify-content-between mt-1">
                                <div class="fw-bold">
                                    ...
                                    <span class="mx-2">|</span>
                                    <span class="fs-12p"><?= Helpers::format_currency($v->price); ?></span>
                                </div>
                                <div class="position-relative">
                                    <div class="d-flex align-items-start justify-content-between">
                                        <div class="dropdown dropstart top-0 end-0" style="z-index: 5;">
                                            <button class="bg-accent icon-40 rounded-circle shadow-sm border-0" type="button" id="contextMenu1" data-bs-toggle="dropdown" aria-expanded="false">
