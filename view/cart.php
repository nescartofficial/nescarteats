        ...
        <div class="card-body">
            <div class="container-lg">
                <?php if ($list) { ?>
                    ...
                    ?>
                        <div class="bg-white rounded p-2 p-lg-3 d-flex justify-content-between align-items-center mb-3 menu-item">
                        ...
                        <div class="card bg-primary--dark rounded-bottom">
                            <div class="card-body py-4">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="mb-0 fs-18p fw-bold cart-total-amount-dp"><?= $total_amount ? ($total_amount) : Helpers::format_currency(0); ?></p>
                                </div>

                                <footer class="mt-5">
                                    <a href="checkout" class="btn bg-white border-0 text-black fw-bold w-100"> Proceed to Checkout</a>
                                </footer>
                            </div> <!-- card-body.// -->
                        </div> <!-- card .// -->
                    </section> <!-- col.// -->
