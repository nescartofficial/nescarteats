                    ...
                    <div class="col-lg-8 mx-auto py-5 text-center">
                        ...
                        <form action="" method="get">
                            <div class="input-group mb-3">
                                ...
                                <span class="input-group-text bg-primary--light border-start-0 border-end-0">|</span>
                                <span class="input-group-text bg-primary--light border-start-0 border-end-0"><i class="fa fa-search"></i></span>
                                <input type="text" name="keyword" class="form-control border-start-0" placeholder="Search for restaurant, cuisine or a dish" aria-label="Search for restaurant, cuisine or a dish" required>
                            </div>
                        </form>
                    </div>
                </div>
