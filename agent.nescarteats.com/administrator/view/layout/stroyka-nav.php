                ...
                <ul class="sa-nav sa-nav--sidebar" data-sa-collapse="">
                    ...
                    <li class="sa-nav__section">
                        ...
                        <ul class="sa-nav__menu sa-nav__menu--root">
                            ...
                            <li class="sa-nav__menu-item"><a href="agents" class="sa-nav__link"><img src="<?= SITE_URL ?>assets/icons/Dashboard.svg" class="icon-menu svg-inline--fa text-white me-4"><span class="sa-nav__title">Agents</span></a></li>
                        </ul>
                    </li>
                    <li class="sa-nav__section">
