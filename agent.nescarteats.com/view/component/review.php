                    ...
                    <div class="d-flex align-items-center justify-content-between mb-2">
                        <div class="d-flex">
                            <?php if ($profile->image) { ?>
                                <img src="assets/images/profile/<?= $profile->image ?>" alt="" style="height: 48px; width: 48px; object-fit: cover; border-radius: 100%">
                            <?php } else { ?>
                        ...
                        <p class="fs-12p mb-0"><?= $v->rating ?>.0 <i class="fa fa-star"></i></p>
                    </div>
                    <div class="body">
