                                    ...
                                    <header class="img-hover-zoom mb-2">
                                        ...
                                        <div class="menu-slider--item" data-flickity='{"pageDots": false, "autoPlay": 4500, "lazyLoad": true, "prevNextButtons": false, "fullscreen": true}'>
                                            <?php foreach ($images as $ik => $iv) { ?>
                                                    <img src="assets/images/menus/nescart-menu-lazyload.png" data-flickity-lazyload="assets/images/menus/<?= $iv ?>" alt="<?= $v->title ?>" class="img-fluid rounded carousel-image">
                                            <?php } ?>
                                        </div>
                                    </header>
        ...
        <div class="modal-dialog modal-dialog-centered  modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body position-relative">
                    <!--Loader-->
                    <div class="loader d-flex align-items-center justify-content-center w-100 h-100 position-absolute top-50 start-50 translate-middle bg-primary--light text-accent" style="z-index: 1;"> 
