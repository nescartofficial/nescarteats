            ...
            <div class="container-lg">
                <?php if ($list) { ?>
                    ...
                    <?php foreach ($list as $index => $con) {
                        ...
                        $variation_titles = $con['variations'] ? $con['variations']['title'] : null;

                        $addon_titles = '';
                        $addon_list = $con['addons'];
                    ...
                    ?>
                        <div class="bg-white rounded p-2 p-lg-3 d-lg-flex justify-content-between align-items-center mb-3 menu-item">
                            <div class="d-flex">
                                <img src="assets/images/menus/<?= $menu->cover; ?>" class="img-sm me-3 rounded align-self-start" style="width: 60px;height: 60px; object-fit: cover;">
    
                                <div class="flex-grow-1">
                                    <a href="menu/<?= $menu->slug ?>" class="d-block fs-18p mb-0 fw-bold">
                                        <?= $con['name']; ?></a>
    
                                    <span class="text-black fs-14p fw-bold"><?= Helpers::format_currency($con['amount']); ?></span>
    
                                    <?= $variation_titles ? "<p class='text-black mb-0 fs-12p'> Variations: {$variation_titles}</p>" : null; ?>
                                    <?php if ($addon_titles) { ?>
                                        <p class='text-black mb-1 fs-12p'> Addons: <?= trim($addon_titles, ',') ?></p>
                                    <?php } ?>
                        ...
                        <div class="card bg-primary--dark rounded-bottom">
                            <div class="card-body py-4">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="mb-0 fs-18p fw-bold cart-total-amount-dp"><?= $total_amount ? Helpers::format_currency($total_amount) : Helpers::format_currency(0); ?></p>
                                </div>

                                <footer class="mt-5">
                                    <a href="checkout" class="btn border-0 text-black fw-bold w-100"> Proceed to Checkout</a>
                                </footer>
                            </div> <!-- card-body.// -->
                        </div> <!-- card .// -->
                    </section> <!-- col.// -->
                ...
                <?php } else { ?>
                    <div class="h-100 d-flex align-items-center justify-content-center py-5">
                        <div class="text-center">
                            ...
                            <a href="find-vendors" class="btn bg-site-accent">Get Started</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
