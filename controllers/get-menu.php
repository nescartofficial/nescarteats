            ...
            if ($menu) {
                ...
                if ($variation_list) {
                    foreach ($variation_list as $k => $variation) {
                        ...
                        $mvariation .= "
                        <div class='col-6 col-lg-4 card h-100 '>
                            ...
                            <label class='btn btn-outline-danger menu-variation-btn {$active}' for='variation-{$variation->id}'>
                ...
                if ($addon_list) {
                    foreach ($addon_list as $k => $addon) {
                        ...
                        <div class='col-6 col-lg-4 card h-100 '>
                            ...
                            <label class='btn btn-outline-danger menu-addon-btn {$active}' for='addon-{$addon->id}'>
