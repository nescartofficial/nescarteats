                                        ...
                                        <div class="sa-symbol sa-symbol--shape--circle" style="--sa-symbol--size:6rem">
                                            <?php if ($vendor && isset($vendor->image) && $vendor->image != 'user-avatar.jpg') { ?>
                                                <div class="sa-symbol sa-symbol--shape--rounded sa-symbol--size--lg">
                                                    <img src="<?= SITE_URL ?>media/images/profile/<?= $vendor->image; ?>" width="96" height="96" alt="" style="object-fit: cover;" />
                                                </div>
                                            <?php } else { ?>
                            ...
                            <div class="card mt-5">
                                ...
                                <?php if ($verification) { ?>
                                    <div class="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                        ...
                                        <a href="<?= SITE_URL ?>media/images/cac/<?= $verification->cac_file; ?>" target="_blank" rel="noopener noreferrer"><img src="<?= SITE_URL; ?>media/images/cac/<?= $verification->cac_file; ?>" alt="" class="img-fluid" style="height:50px"></a>
                                    </div>
                                    <div class="px-5 py-3 my-2 d-flex align-items-center justify-content-between">
                                        <span class="">TIN: <?= $verification->tin; ?></span>
                                        <a href="<?= SITE_URL ?>media/images/tin/<?= $verification->tin_file; ?>" target="_blank" rel="noopener noreferrer"><img src="<?= SITE_URL; ?>media/images/tin/<?= $verification->tin_file; ?>" alt="" class="img-fluid" style="height:50px"></a>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
