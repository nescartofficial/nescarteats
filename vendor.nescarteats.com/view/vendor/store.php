                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="time" name="closing_time" value="<?= $vendor && isset($vendor->closing_time) ? $vendor->closing_time : ($form_data ? $form_data['closing_time'] : $user->data()->closing_time); ?>" id="closing_time" class="form-control" placeholder="Input your closing time" required>
                        ...
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" name="delivery_time" value="<?= $vendor && isset($vendor->delivery_time) ? $vendor->delivery_time : ($form_data ? $form_data['delivery_time'] : $user->data()->delivery_time); ?>" id="delivery_time" class="form-control" placeholder="Input your delivery time" required>
